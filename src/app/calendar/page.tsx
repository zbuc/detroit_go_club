    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="grid md:grid-cols-1 gap-8">
        <div className="bg-white rounded-lg shadow-sm border p-6">
          <h1 className="text-4xl font-bold text-gray-900 mb-8">Meetup Calendar</h1>

          {upcomingMeetups.length > 0 && (
            <section className="mb-12">
              <h2 className="text-2xl font-semibold text-gray-900 mb-6">Upcoming Meetups</h2>
          ...
          {pastMeetups.length > 0 && (
            <section>
              <h2 className="text-2xl font-semibold text-gray-900 mb-6">Past Meetups</h2>
              <div className="grid gap-6">
